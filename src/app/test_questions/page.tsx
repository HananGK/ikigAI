...
export default function TestQuestions({setsList=items}) {
  ...
  const handleChange = (e: any, i: number) => {
      ...
      for (let i = 0; i < newState.length; i++) {
        respuesta = (newState[i].title + ': ' + newState[i].text)
  ...
  return (
    <div className="flex flex-col w-full max-w-4xl py-24 mx-auto gap-14">
      <div className="flex flex-col gap-8">
        ...
        <h3 className="text-center text-xl">Responde por favor a las siguientes 4 preguntas con calma y realizando un ejercicio de introspección, así también te conocerás mejor y obtendrás mejores resultados</h3>
      </div>
